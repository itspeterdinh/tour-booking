...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoicGV0ZXJkaW5oOTQiLCJhIjoiY2t4amJwMjRrMG9pODJ3cGVyNWwxYTR1aiJ9.nW5ga2Ny38zQw5e6kLxmLA';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/peterdinh94/ckxji805hbkby15mp01qfwfzk',
    scrollZoom: false //   center: [-121.95336695016951, 37.31222530444375],
    //   zoom: 4,
    //   interactive: false
...
var stripe = Stripe('pk_test_51KB7i7ErJHfXsveUncxNR9it1kyD1HJN3UpHxE1Z02XbsnaoYiyD2nIc8clovffoOCIHP3NHGyA1O0TMgKz5PZWp00VKW7NaGO');
